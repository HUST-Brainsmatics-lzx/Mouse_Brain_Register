function [imgw, imgwr, map] = tpswarp(img, outDim, Zp, Zs )
%
...
interp.radius = 3; % radius or median filter dimension
interp.power = 2; %power for inverse wighting interpolation method
